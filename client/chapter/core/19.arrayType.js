...
// 배열 선언
//# .split(',') : 문자인 객체의 능력으로 배열로 만들어주는 역할
//# 원시래퍼객체이기 때문에 가능
let friends = '진승, 혜미, 송이, 효윤, 선용, 승민, 상효, 영은, 희소'.split(',');
console.log(friends);
// 배열 요소의 총 갯수
//@ length 의 길이를 변경하는 것은 하지 말자! 배열 다 날라감
...
let copiedArray = friends.toSorted(); // 정렬을 하면서 복사를 해줌
