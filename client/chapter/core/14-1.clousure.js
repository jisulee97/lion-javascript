...
//@ 전역의 오염을 막기 위해
//@ 값을 기어갛기 위해(가비지 컬렉터 수집 x)
//@ 함부로 내가 설정한 값을 수정할 수 없기(특정 함수를 통해서만 접근)
...
//     //@ second 함수에 x + y 를 한다
//     //@ 상위 함수에서 x 의 값을 가져와 더함
//     return x + y; // 15
//   }
//   //@ x + y 한 값을 리턴해줘야 함(x + y 한 값이 second 안에 들어있음)
//   return second(); // 15
// }
// //@ 15 라는 값이 first() 함수에 담긴다
...
//# currying function
//@ return second 에서 함수를 실행하지 않았기 떄문에 first()() 로 실행해줌
// first()();

const value = first();
//# => second 함수 본문이 담김, 본문이 실행됨과 동시에 value 에 담김
//# first() = second 함수 본문이 담긴 것
//# 이를 실행하려면 value() 라고 해줘야함
//# value = first()()
//# 함수를 실행시키지 않으면 본문만 내보내짐
